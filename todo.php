...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" type="" href="todo.css">
    </head>
    ...
    <body>
        ...
        <div class "main">
            ...
            <div class="container">
                ...
                $result = $mysqli->query("SELECT * FROM list WHERE email = '$mail'") or die($mysqli->error);
                //pre_r($result);
                ...
                <div class="row justify-content-center">
                    <form action=" addlist.php" method="POST">
                        <div class="form-group ">
                            ...
                            <input type="text " placeholder="Enter list " class="form-control " name="list">
                        </div><br><br>
                        <div class="form-group ">
